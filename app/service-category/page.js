...
import { deleteServiceCategoryServ, getServiceCategoryServ } from '../services/serviceCategory.service';
...
const Page = () => {
  ...
  const [label, setLabel] = useState("Select Service Status");
...
const handleDeleteFunc = async () => {
  try {
    ...
    const response = await deleteServiceCategoryServ(deleteId);

    console.log("API Response:", response);

    await fetchCategories(); // 👈 await lagana zaroori
    ...
    <>
     ...
     <div className="container-fluid main-content-box py-3 ms-0">
      ...
      <div className="d-flex justify-content-between align-items-center my-4">
        <h4 className="mb-0"> All Services Categories</h4>
        ...
        <ul className="dropdown-menu show">
          ...
          <button
            ...
            onClick={() => router.push("/service-category/create")}
          >
            + Add Service
          </button>
        </div>
        ...
        <td className="text-center">
          ...
          <button
            className="btn btn-sm btn-outline-primary me-2"
              onClick={() =>
                         router.push(`/service-category/update/${item._id}`)
                              }
          >
