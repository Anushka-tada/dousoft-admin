...
// //   <Input
// //    value={
// //   Array.isArray(data?.highlightWords)
// //     ? data.highlightWords.join(", ")
// //     : data?.highlightWords || ""
// // }
// //     onChange={(e) => u("highlightWords", e.target.value)}
...
// //     value={data?.highlightWords || ""}
// //     onChange={(e) => u("highlightWords", e.target.value)}
// //     placeholder="Business Growth, Success"
// //   />
// // </Field>
...
// //         highlightWords:
// //           typeof formData?.whoWeAre?.highlightWords === "string"
// //             ? formData.whoWeAre.highlightWords
// //                 .split(",")
// //                 .map((item) => item.trim())
// //                 .filter(Boolean)
// //             : formData?.whoWeAre?.highlightWords || [],
...
// //         highlightWords:
// //           typeof formData?.cta?.highlightWords === "string"
// //             ? formData.cta.highlightWords
// //                 .split(",")
// //                 .map((item) => item.trim())
// //                 .filter(Boolean)
// //             : formData?.cta?.highlightWords || [],
...
//         {/* ✅ FIX: Array.isArray check added — same as WhoWeAreEditor */}
//         <Field label="Highlight Words" hint='Comma separated. Example: Software Development, Scalable'>
//           <Input
//             value={
//               Array.isArray(data?.highlightWords)
//                 ? data.highlightWords.join(", ")
...
//         </div>
//         <Field label="Heading"><Input value={data?.heading || ""} onChange={(e) => u("heading", e.target.value)} /></Field>
//         <Field label="Highlight Words" hint="Comma separated">
//           <Input
//             value={
//               Array.isArray(data?.highlightWords)
//                 ? data.highlightWords.join(", ")
...
//   const addCat = () => { u("categories", [...cats, ""]); };
...
//           <Textarea value={data?.description || ""} onChange={(e) => u("description", e.target.value)} />
//         </Field>
//         <ImageUpload label="Center Logo" value={data?.centerLogo} onChange={(v) => u("centerLogo", v)} />
//       </div>
...
//                 style={{ flex: 1 }}
//               />
//               <button className="cms-icon-btn danger" onClick={() => remCat(i)} title="Remove category">
//                 <i className="bi bi-trash" />
//               </button>
//             </div>
//           ))}
...
//                 </Field>
//               </div>
//               <ImageUpload label="Technology Logo" value={t.logo} onChange={(v) => upd(i, "logo", v)} hint="Recommended: 64×64px, transparent PNG" />
//               <div className="cms-orbit-block">
//                 <p style={{ fontSize: 12, fontWeight: 700, color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 10 }}>
//                   <i className="bi bi-circle" style={{ marginRight: 5 }} />Orbit Animation Settings
//                 </p>
...
//         {/* ✅ FIX: Array.isArray check added — was missing, causing array to show as blank/broken */}
//         <Field label="Highlight Words" hint="Comma separated">
//           <Input
//             value={
//               Array.isArray(data?.highlightWords)
...
//           highlightWords:
//             typeof formData?.hero?.highlightWords === "string"
//               ? formData.hero.highlightWords.split(",").map((s) => s.trim()).filter(Boolean)
//               : formData?.hero?.highlightWords || [],
//         },

//         // ── whoWeAre.highlightWords ──────────────────────────────────────────
//         whoWeAre: {
//           ...formData.whoWeAre,
//           highlightWords:
//             typeof formData?.whoWeAre?.highlightWords === "string"
//               ? formData.whoWeAre.highlightWords.split(",").map((s) => s.trim()).filter(Boolean)
//               : formData?.whoWeAre?.highlightWords || [],
//         },
...
//           highlightWords:
//             typeof formData?.cta?.highlightWords === "string"
//               ? formData.cta.highlightWords.split(",").map((s) => s.trim()).filter(Boolean)
//               : formData?.cta?.highlightWords || [],
//         },
//       };
...
//         /* ── Preview divider ── */
//         .cms-preview-divider { display: flex; align-items: center; gap: 12px; margin: 32px 0 0; padding-top: 8px; }
//         .cms-preview-divider span { font-size: 14px; font-weight: 700; color: #6b7280; text-transform: uppercase; letter-spacing: 0.07em; white-space: nowrap; display: flex; align-items: center; gap: 6px; }
//         .cms-preview-divider-line { flex: 1; height: 1px; background: #e5e7eb; }
